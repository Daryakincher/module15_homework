...
const btnDOM = document.querySelector('.j-btn-test');
const iconDOM = document.querySelector('.btn_icon');
...
iconDOM.innerHTML = buttonStage ? icon_02: icon_01;

  btn.classList.toggle('btn--magic');
});
document.addEventListener("DOMContentLoaded", function () {
  iconDOM.innerHTML = icon_01;
 });